...
exports.default = _default;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"auth.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePassword = exports.updateMe = exports.signUp = exports.resetPassword = exports.login = exports.logOut = exports.forgotPassword = exports.deleteMe = void 0;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.message === "success") {
              (0, _alert.showAlert)("success", "Logging you out!");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            res = _context3.sent;
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Account created succesfully!");
              window.setTimeout(function () {
                location.assign("/");
              }, 2000);
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(token, password, passwordConfirm) {
    var res;
...
var updatePassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(passwordCurrent, password, passwordConfirm) {
    var res;
  ...
  return function updatePassword(_x11, _x12, _x13) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            res = _context7.sent;
            if (res.status === 204) {
              (0, _alert.showAlert)("success", "Account Deleted successfully! ");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
...
var updateMe = /*#__PURE__*/function () {
  ...
  return function updateMe(_x14) {
    return _ref8.apply(this, arguments);
  };
}();
exports.updateMe = updateMe;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"genreFunc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deteleGenre = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deteleGenre = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(genName) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/genre/".concat(genName),
              method: "DELETE"
            });
          case 3:
            res = _context.sent;
            if (res.status == 204) {
              (0, _alert.showAlert)("success", "Genre deleted successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 2000);
            }
  ...
  return function deteleGenre(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.deteleGenre = deteleGenre;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"movieFunc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getSearchedMovies = exports.dislikeMovie = exports.deleteMovieReview = exports.deleteMovie = exports.addToWatchList = exports.addMovie = void 0;
exports.gettingUserStats = gettingUserStats;
exports.removeFromWatchList = exports.likeMovie = exports.giveReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Movie added successfully!");
              window.setTimeout(function () {
...
var likeMovie = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/movies/".concat(slug, "/like"),
              method: "POST"
            });
          case 3:
            res = _context2.sent;
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Hurray you liked it!");
  ...
  return function likeMovie(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
exports.likeMovie = likeMovie;
var dislikeMovie = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/movies/".concat(slug, "/dislike"),
              method: "POST"
            });
          case 3:
            res = _context3.sent;
            if (res.data.status === "success") {
              (0, _alert.showAlert)("error", "Ohho! we will improve");
  ...
  return function dislikeMovie(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
exports.dislikeMovie = dislikeMovie;
var addToWatchList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/users/".concat(slug, "/watchlist/add"),
              method: "POST"
            });
          case 3:
            res = _context4.sent;
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Movie added to the watchlist!");
              window.setTimeout(function () {
  ...
  return function addToWatchList(_x4) {
    return _ref4.apply(this, arguments);
  };
}();
exports.addToWatchList = addToWatchList;
var removeFromWatchList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/users/".concat(slug, "/watchlist/remove"),
              method: "POST"
            });
          case 3:
            res = _context5.sent;
            if (res.data.status == "success") {
              (0, _alert.showAlert)("success", "Movie removed from watchlist!");
              window.setTimeout(function () {
                location.reload(true);
              }, 2000);
            }
  ...
  return function removeFromWatchList(_x5) {
    return _ref5.apply(this, arguments);
  };
}();
...
var deleteMovie = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            res = _context6.sent;
            if (res.status == 204) {
              (0, _alert.showAlert)("success", "Movie deleted successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 2000);
            }
          ...
          case 7:
            _context6.prev = 7;
            _context6.t0 = _context6["catch"](0);
            (0, _alert.showAlert)("error", _context6.t0.message);
            window.setTimeout(function () {
              location.reload(true);
            }, 2000);
          case 11:
  ...
  return function deleteMovie(_x6) {
    return _ref6.apply(this, arguments);
  };
}();
exports.deleteMovie = deleteMovie;
var giveReview = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id, review, rating) {
    var res;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/movies/".concat(id, "/reviews"),
              method: "POST",
              data: {
                review: review,
                rating: rating
  ...
  return function giveReview(_x7, _x8, _x9) {
    return _ref7.apply(this, arguments);
  };
}();
exports.giveReview = giveReview;
var deleteMovieReview = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 3:
            res = _context8.sent;
            if (res.data.status == "success") {
              (0, _alert.showAlert)("success", "Result fetched!");
              window.setTimeout(function () {
                location.reload(true);
              }, 2000);
            }
  ...
  return function deleteMovieReview(_x10) {
    return _ref8.apply(this, arguments);
  };
}();
exports.deleteMovieReview = deleteMovieReview;
var getSearchedMovies = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/movies?name=".concat(name),
              method: "DELETE"
            });
          case 3:
            res = _context9.sent;
            if (res.status == 204) {
              (0, _alert.showAlert)("success", "Review deleted succesfully!");
  ...
  return function getSearchedMovies(_x11) {
...
function gettingUserStats() {
  return _gettingUserStats.apply(this, arguments);
} // console.log(stats);
function _gettingUserStats() {
  _gettingUserStats = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
    var res, stats;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            stats = [];
            if (res.data.status === "success") {
              Object.values(res.data.resp).forEach(function (el) {
                stats.push(el);
              });
              new Chart(ctx, {
                type: "pie",
          ...
          case 8:
            ...
            (0, _alert.showAlert)("error", "Chart is already displayed!");
          case 11:
          case "end":
...
var _genreFunc = require("./genreFunc.js");
var _movieFunc = require("./movieFunc.js");
var inputUserName = document.getElementById("user-name");
var inputName = document.getElementById("name");
var inputEmail = document.getElementById("email");
var inputCurrentPass = document.getElementById("password-current");
var inputPass = document.getElementById("password");
var inputConfPass = document.getElementById("password-confirm");
var inputReview = document.getElementById("review-text");
var inputRating = document.getElementById("Numbers");
var inputMov = document.getElementById("searchInput");
var inputMovieName = document.getElementById("movie-name");
var inputMovieGenre = document.getElementById("movie-genre");
var inputMoviedescrp = document.getElementById("movie-desc");
var inputMovieImbd = document.getElementById("movie-imbd");
var inputMovieUrl = document.getElementById("movie-url");
var resetToken = document.getElementById("reset-token");
var btnGetToken = document.getElementById("getToken");
var btnLike = document.getElementById("likemovie");
var btnDislike = document.getElementById("dislikemovie");
var btnAddToWatchList = document.getElementById("watchlater");
var btnRemoveFromWatchList = document.getElementById("remove-movie");
var btnDeleteMovie = document.querySelectorAll(".deletemovie");
var btnDeleteGenre = document.querySelectorAll(".deletegenre");
var btnDeleteMe = document.getElementById("delete-me");
var btnDeleteReview = document.querySelectorAll(".deleteReview");
var btnGetUserStats = document.querySelector(".user-stats");
var movFrame = document.querySelector(".movie-frame");
var formAddMovie = document.querySelector(".form-add-movie");
...
var formUpdateMe = document.getElementById("user-data");
var updatePassForm = document.getElementById("update-pass");
var fromReview = document.querySelector(".review-rate");
var formSearch = document.querySelector(".search-form");
var formDeleteMe = document.querySelector(".form-deleteME");
...
if (formLogin) formLogin.addEventListener("submit", function (e) {
  e.preventDefault();
  (0, _auth.login)(inputEmail.value, inputPass.value);
});
...
if (formSignup) formSignup.addEventListener("submit", function (e) {
  e.preventDefault();
  (0, _auth.signUp)(inputUserName.value, inputEmail.value, inputPass.value, inputConfPass.value);
});
if (btnGetToken) btnGetToken.addEventListener("click", function (e) {
  e.preventDefault();
  if (email.value) {
    (0, _auth.forgotPassword)(email.value);
...
if (resetPassForm) resetPassForm.addEventListener("submit", function (e) {
  ...
  if (resetToken.value && inputPass.value && inputConfPass.value) {
    (0, _auth.resetPassword)(resetToken.value, inputPass.value, inputConfPass.value);
    e.target.textContent = "resetting...";
  }
});
if (btnLike) {
  btnLike.addEventListener("click", function () {
    var movSlug = btnLike.dataset.slug;
    (0, _movieFunc.likeMovie)(movSlug);
    btnLike.textContent = "Liked";
  });
}
if (btnAddToWatchList) {
  btnAddToWatchList.addEventListener("click", function () {
    var movSlug = btnAddToWatchList.dataset.slug;
    (0, _movieFunc.addToWatchList)(movSlug);
  });
}
if (btnRemoveFromWatchList) {
  btnRemoveFromWatchList.addEventListener("click", function () {
    var movSlug = btnRemoveFromWatchList.dataset.slug;
    (0, _movieFunc.removeFromWatchList)(movSlug);
  });
}
if (btnDislike) {
  btnDislike.addEventListener("click", function () {
    var movSlug = btnDislike.dataset.slug;
    (0, _movieFunc.dislikeMovie)(movSlug);
    btnDislike.textContent = "disliked";
  });
}
if (btnDeleteMovie) {
  btnDeleteMovie.forEach(function (btn) {
    btn.addEventListener("click", function () {
      var movId = btn.dataset.id;
      (0, _movieFunc.deleteMovie)(movId);
    });
  });
}
if (btnDeleteGenre) {
  btnDeleteGenre.forEach(function (btn) {
    btn.addEventListener("click", function () {
      var genName = btn.dataset.name;
      (0, _genreFunc.deteleGenre)(genName);
    });
  });
}
if (updatePassForm) {
  updatePassForm.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _auth.updatePassword)(inputCurrentPass.value, inputPass.value, inputConfPass.value);
  });
}
if (fromReview) {
  fromReview.addEventListener("submit", function (e) {
    e.preventDefault();
    var movId = fromReview.dataset.id;
    (0, _movieFunc.giveReview)(movId, inputReview.value, inputRating.value);
  });
}
if (formSearch) {
  formSearch.addEventListener("submit", function (e) {
    e.preventDefault();
    var name = inputMov.value;
    (0, _movieFunc.getSearchedMovies)(name);
    inputMov.value = "";
  });
}
if (formDeleteMe) {
  formDeleteMe.addEventListener("submit", function (e) {
    e.preventDefault();
    var email = btnDeleteMe.dataset.id;
    if (inputEmail.value === email) {
      alert("Please confirm if you really want to delete your account!");
      (0, _auth.deleteMe)();
    } else {
      (0, _alert.showAlert)("error", "Incorrect email! Try again later");
    }
  });
}
if (btnDeleteReview) {
  btnDeleteReview.forEach(function (btn) {
    return btn.addEventListener("click", function () {
      var revId = btn.dataset.id;
      (0, _movieFunc.deleteMovieReview)(revId);
    });
  });
}
if (formUpdateMe) {
  formUpdateMe.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    (0, _auth.updateMe)(form);
  });
}
if (formAddMovie) formAddMovie.addEventListener("submit", function (e) {
  e.preventDefault();
  var form = new FormData();
